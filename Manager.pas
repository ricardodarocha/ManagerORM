...
TManager<T: class, constructor> = class
  ...
  function Post(var aObject: T; vUpdateSQL: String; const aParametros: Array of Variant): Boolean; overload;
  function post(var aObject: T): boolean; overload;
...
function TManager<T>.Post(var aObject: T): boolean;
begin
  MapToQuery(aObject);
  fFdQuery.Post;
end;
...
function TManager<T>.Iterate: Boolean;
begin
  result := fFdQuery.Eof;

  MapFromQuery(fObject);
  fFdQuery.Next;
end;
